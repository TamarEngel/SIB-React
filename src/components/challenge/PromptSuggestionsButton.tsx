...
//               bottom: '-1px',
//               borderRadius: '50%',
//               background: 'linear-gradient(135deg, rgba(241, 83, 93, 0.5), transparent, rgba(237, 193, 6, 0.5))',
//               opacity: 0.2,
...
//                   background: 'linear-gradient(135deg, rgba(241, 83, 93, 0.8), rgba(237, 193, 6, 0.8))',
//                 }}>
//                   <SmartToyIcon sx={{ color: '#fff', fontSize: '18px' }} />
//                 </Avatar>
//                 <Box>
...
//                         width: 26,
//                         height: 26,
//                         bgcolor: message.role === "user" ? 'rgba(255, 255, 255, 0.1)' : 'rgba(241, 83, 93, 0.15)',
//                         border: message.role === "user" 
//                           ? '1px solid rgba(255, 255, 255, 0.2)'
//                           : '1px solid rgba(241, 83, 93, 0.3)',
//                         fontSize: '14px'
//                       }}
//                     >
//                       {message.role === "user" ? (
//                         <PersonIcon sx={{ color: '#fff', fontSize: '14px' }} />
//                       ) : (
//                         <SmartToyIcon sx={{ color: '#fff', fontSize: '14px' }} />
//                       )}
//                     </Avatar>
//                     <Paper
//                       elevation={0}
...
//                         borderLeft: message.role === "assistant" ? '2px solid rgba(241, 83, 93, 0.3)' : undefined,
//                         borderRight: message.role === "user" ? '2px solid rgba(255, 255, 255, 0.2)' : undefined,
//                         color: '#fff',
//                         direction: 'rtl',
//                         maxWidth: '100%',
//                         wordBreak: 'break-word'
...
//                         borderLeft: '2px solid rgba(241, 83, 93, 0.3)',
//                       }}
//                     >
//                       <TypingIndicator />
//                     </Paper>
...
//                     },
//                     '&.Mui-focused fieldset': {
//                       borderColor: 'rgba(241, 83, 93, 0.5)',
//                       borderWidth: '1px',
//                     },
//                   },
//                   '& .MuiInputBase-input::placeholder': {
...
//                     disabled={loading || !input.trim()} 
//                     sx={{
//                       background: 'linear-gradient(135deg, rgba(241, 83, 93, 0.9), rgba(237, 193, 6, 0.9))',
//                       color: 'white',
//                       height: '38px',
//                       width: '38px',
//                       '&:hover': { 
//                         background: 'linear-gradient(135deg, rgba(241, 83, 93, 1), rgba(237, 193, 6, 1))',
